// ============================================================
// 🎮 GAME BOOSTER ALPHA v6.2 — ANTI-LEAK PURE JORDAN 2026
// ═══════════════════════════════════════════════════════════
// الإصلاحات في v6.2 (Anti-Leak):
//   ★ حجب IPv6 تماماً (يتجاوز البروكسي ويكشف IP الحقيقي)
//   ★ حجب نطاقات فحص الاتصال (Captive/Connectivity)
//   ★ حجب نطاقات WebRTC (STUN/TURN) لمنع تسريب IP
//   ★ تعديل Fallback: الترافيك المجهول يمر عبر البروكسي
//   ★ حجب الطلبات فاشلة DNS لمنع تسريب DNS
//   ★ إعادة تنسيق كامل للكود لسهولة القراءة والصيانة
// ============================================================
...
// ============================================================
// ⚙️ الإعدادات الرئيسية (CONFIG)
// ============================================================
var CONFIG = {
  // سيرفرات MAT — Orange Jordan / Umniah
  ...
  // ★★★ مفاتيح التوجيه (DIRECT لتفادي حوض الـ VPN) ★★★
  FORCE_MATCH_DIRECT: true,       
  FORCE_RECRUIT_DIRECT: true,     
  FORCE_VOICE_DIRECT: true,       
  FORCE_LOBBY_THROUGH_PROXY: true,
  FORCE_SOCIAL_THROUGH_PROXY: false,
  FORCE_ALL_THROUGH_PROXY: false, 
...
// ============================================================
var JORDAN_TIER1 = [
  ["46.185.0.0","255.255.0.0"], ["212.35.64.0","255.255.224.0"],
  ["212.34.0.0","255.255.0.0"], ["212.118.0.0","255.255.0.0"],
  ["46.32.0.0","255.255.0.0"],  ["194.165.130.0","255.255.255.0"]
];
var JORDAN_TIER2 = [
  ["178.77.0.0","255.255.0.0"], ["178.76.0.0","255.255.0.0"],
  ["82.137.192.0","255.255.192.0"], ["176.29.0.0","255.255.0.0"],
  ["176.28.0.0","255.255.0.0"], ["176.57.0.0","255.255.0.0"]
];
var JORDAN_TIER3 = [
  ["188.161.0.0","255.255.0.0"], ["188.123.0.0","255.255.0.0"],
  ["188.247.0.0","255.255.0.0"], ["188.225.0.0","255.255.0.0"]
];
var JORDAN_TIER4 = [
  ["37.202.0.0","255.255.0.0"], ["37.252.0.0","255.255.0.0"],
  ["213.202.0.0","255.255.0.0"], ["213.139.0.0","255.255.0.0"]
];
var JORDAN_TIER5 = [
...
var JORDAN_RANGES = [].concat(JORDAN_TIER1, JORDAN_TIER2, JORDAN_TIER3, JORDAN_TIER4, JORDAN_TIER5);

// ============================================================
// 🛡️ نطاقات التسريب — حجب (Anti-Leak)
// ============================================================
var LEAK_PATTERNS = [
  "*captive*", "*connectivitycheck*", "*detectportal*",
  "*networkcheck*", "*msftncsi*", "*apple.com/library/test*",
  "*wlan*", "*hotspotdetect*", "*stun*", "*turn*", "*ice*",
  "*geo*", "*location*", "*gps*"
];
...
// ============================================================
var MATCH_PATTERNS = [
  "*match*.pubgmobile.com", "*match*.tencentigame.com", "*game*.pubgmobile.com",
  "*game*.tencent.com", "*battle*.pubgmobile.com", "*arena*.pubgmobile.com",
  "*ranked*.pubgmobile.com", "*classic*.pubgmobile.com", "*tdm*.pubgmobile.com",
  "*payload*.pubgmobile.com", "*livik*.pubgmobile.com", "*erangel*.pubgmobile.com",
  "*miramar*.pubgmobile.com", "*sanhok*.pubgmobile.com", "*vikendi*.pubgmobile.com",
  "*karakin*.pubgmobile.com", "*nusa*.pubgmobile.com", "*aftermath*.pubgmobile.com",
  "*server*.pubgmobile.com", "*gate*.pubgmobile.com", "*gateway*.pubgmobile.com",
  "*connect*.pubgmobile.com", "*session*.pubgmobile.com", "*realtime*.pubgmobile.com",
  "*sync*.pubgmobile.com", "*play*.pubgmobile.com", "*enter*.pubgmobile.com",
  "*start*.pubgmobile.com", "*.igamecj.com", "*.proximabeta.com",
  "*.proximabeta.net", "*.gcloudcs.com"
];

var LOBBY_PATTERNS = [
  "*lobby*.pubgmobile.com", "*lobby*.tencent.com", "*lobby*.tencentigame.com",
  "*main*.pubgmobile.com", "*home*.pubgmobile.com", "*menu*.pubgmobile.com",
  "*hub*.pubgmobile.com", "*ready*.pubgmobile.com", "*waiting*.pubgmobile.com"
];

var RECRUIT_PATTERNS = [
  "*recruit*.pubgmobile.com", "*team*.pubgmobile.com", "*matchmake*.pubgmobile.com",
  "*queue*.pubgmobile.com", "*invite*.pubgmobile.com", "*group*.pubgmobile.com",
  "*squad*.pubgmobile.com", "*duo*.pubgmobile.com", "*party*.pubgmobile.com",
  "*find*.pubgmobile.com", "*search*.pubgmobile.com", "*join*.pubgmobile.com"
];

var VOICE_PATTERNS = [
  "*voice*.pubgmobile.com", "*rtc*.tencent.com", "*trtc*.com", "*trtc*.tencent.com",
  "*voip*.pubgmobile.com", "*audio*.pubgmobile.com", "*speak*.pubgmobile.com",
  "*mic*.pubgmobile.com", "*talk*.pubgmobile.com", "*call*.pubgmobile.com",
  "*media*.pubgmobile.com", "*stream*.pubgmobile.com", "*rtc*.gcloudcs.com",
  "*av*.tencent.com", "*imservice*.tencent.com"
];

var UPLOAD_PATTERNS = [
  "*upload*.pubgmobile.com", "*upload*.tencent.com", "*put*.pubgmobile.com",
  "*post*.pubgmobile.com", "*submit*.pubgmobile.com", "*send*.pubgmobile.com",
  "*input*.pubgmobile.com", "*action*.pubgmobile.com", "*cmd*.pubgmobile.com",
  "*position*.pubgmobile.com"
];

var DOWNLOAD_PATTERNS = [
  "*download*.pubgmobile.com", "*download*.tencent.com", "*get*.pubgmobile.com",
  "*fetch*.pubgmobile.com", "*receive*.pubgmobile.com", "*payload*.pubgmobile.com",
  "*data*.pubgmobile.com", "*response*.pubgmobile.com", "*tick*.pubgmobile.com",
  "*snapshot*.pubgmobile.com"
];

var SOCIAL_PATTERNS = [
  "*social*.pubgmobile.com", "*chat*.pubgmobile.com", "*message*.pubgmobile.com",
  "*msg*.pubgmobile.com", "*friend*.pubgmobile.com", "*mail*.pubgmobile.com",
  "*inbox*.pubgmobile.com", "*gift*.pubgmobile.com"
];

var CLAN_PATTERNS = [
  "*clan*.pubgmobile.com", "*crew*.pubgmobile.com", "*guild*.pubgmobile.com",
  "*war*.pubgmobile.com", "*clash*.pubgmobile.com", "*versus*.pubgmobile.com"
];

var SHOP_PATTERNS = [
  "*shop*.pubgmobile.com", "*store*.pubgmobile.com", "*buy*.pubgmobile.com",
  "*purchase*.pubgmobile.com", "*payment*.pubgmobile.com", "*uc*.pubgmobile.com",
  "*bp*.pubgmobile.com", "*crate*.pubgmobile.com", "*spin*.pubgmobile.com",
  "*royal*.pubgmobile.com", "*pass*.pubgmobile.com", "*skin*.pubgmobile.com"
];

var EVENT_PATTERNS = [
  "*event*.pubgmobile.com", "*mission*.pubgmobile.com", "*task*.pubgmobile.com",
  "*challenge*.pubgmobile.com", "*reward*.pubgmobile.com", "*daily*.pubgmobile.com",
  "*weekly*.pubgmobile.com", "*bonus*.pubgmobile.com", "*special*.pubgmobile.com",
  "*promo*.pubgmobile.com"
];

var RANK_PATTERNS = [
  "*rank*.pubgmobile.com", "*leaderboard*.pubgmobile.com", "*rating*.pubgmobile.com",
  "*tier*.pubgmobile.com", "*score*.pubgmobile.com", "*stat*.pubgmobile.com",
  "*stats*.pubgmobile.com", "*history*.pubgmobile.com", "*achievement*.pubgmobile.com"
];

var AUTH_PATTERNS = [
  "*auth*.pubgmobile.com", "*login*.pubgmobile.com", "*token*.pubgmobile.com",
  "*verify*.pubgmobile.com", "*session*.pubgmobile.com", "*passport*.pubgmobile.com",
...
var PROFILE_PATTERNS = [
  "*profile*.pubgmobile.com", "*user*.pubgmobile.com", "*account*.pubgmobile.com",
  "*player*.pubgmobile.com", "*avatar*.pubgmobile.com", "*setting*.pubgmobile.com"
];

var PUSH_PATTERNS = [
  "*push*.pubgmobile.com", "*notify*.pubgmobile.com", "*notification*.pubgmobile.com",
  "*alert*.pubgmobile.com", "*announce*.pubgmobile.com", "*ping*.pubgmobile.com"
];

var CDN_PATTERNS = [
  "*.cdn.pubgmobile.com", "*.static.pubgmobile.com", "*.assets.pubgmobile.com",
  "*.resource.pubgmobile.com", "*.update.pubgmobile.com", "*.patch.pubgmobile.com",
  "*.download.pubgmobile.com", "*.content.pubgmobile.com", "*.img*.pubgmobile.com",
  "*.bundle*.pubgmobile.com", "*.pak*.pubgmobile.com"
];

var ANALYTICS_PATTERNS = [
  "*analytics*", "*telemetry*", "*metrics*", "*tracking*", "*crash*",
  "*log*.pubgmobile.com", "*report*.pubgmobile.com", "*monitor*",
  "*diagnostic*", "*survey*"
];

var TELEMETRY_DOMAINS = [
  "*app-measurement.com", "*firebase*", "*google-analytics*", "*crashlytics*",
  "*adjust.com", "*appsflyer.com", "*branch.io", "*singular.net",
  "*amplitude.com", "*mixpanel.com"
];

var TENCENT_PATTERNS = [
  "*.tencent.com", "*.qq.com", "*.gcloudlb.com", "*.tencentyun.com",
  "*.qcloud.com", "*.qpic.cn", "*.gtimg.cn", "*.idqqimg.com",
  "*.qlogo.cn", "*.gtimg.com", "*.myqcloud.com", "*.tencent-cloud.net"
];

// ============================================================
// نظام التخزين المؤقت (SESSION)
// ============================================================
var SESSION = {
  match: {
  ...
  counters: {
    ...
    cdnRequests: 0, blockedRequests: 0, forcedProxy: 0, directMatch: 0,
    failovers: 0, dnsCacheHits: 0, dnsCacheMisses: 0, latencyBlocked: 0,
    analyticsBlocked: 0, leakBlocked: 0,
...
function prefetchDNS() {
  ...
  var list = [
    "match.pubgmobile.com", "game.pubgmobile.com", "lobby.pubgmobile.com",
    "voice.pubgmobile.com", "login.pubgmobile.com", "shop.pubgmobile.com",
...
// ============================================================
// 🕵️ تصنيف الترافيك (Traffic Classification)
// ============================================================
function isPUBGTraffic(host) {
  if (!host) return false;
  var domains = [
    "pubgmobile.com", "tencentigame.com", "igamecj.com", "proximabeta.com",
    "proximabeta.net", "gcloudcs.com", "tencent.com", "qq.com", "gcloudlb.com",
    "tencentyun.com", "qcloud.com", "qpic.cn", "gtimg.cn", "idqqimg.com",
    "qlogo.cn", "gtimg.com", "myqcloud.com", "tencent-cloud.net"
  ];
...
function isLeakTraffic(u, h)      { return matchesPattern(u, h, LEAK_PATTERNS); } // ★ Anti-Leak

// ============================================================
// 🔀 نظام البروكسي وسلاسل الفشل
// ============================================================
function getBestProxy(proxyList) {
  var best = proxyList[0]; var bestScore = 0;
...
function selectLobbyProxy(host, ip) {
  var prefix = getNetworkPrefix(ip); var tier = getJordanTier(ip); var preferred;
  switch(tier) {
  ...
  var current = SESSION.lobby.affinityMap[prefix]; var health = SESSION.proxyHealth[current];
  if (health && health.score > 50) return current;
  var best = getBestProxy(CONFIG.LOBBY_FAST); SESSION.lobby.affinityMap[prefix] = best; return best;
}

// بناء سلاسل البروكسي (Chains)
...
function buildForcedJordanChain() { return CONFIG.MATCH_TIER1 + "; " + CONFIG.MATCH_TIER2 + "; " + CONFIG.MATCH_TIER3 + "; " + CONFIG.MATCH_TIER4; }

// ============================================================
// 🛡️ مكافحة الذبذبة والصيانة
// ============================================================
function updateConnectionQuality() {
  ...
  if (SESSION.match.locked) {
    ...
    if (SESSION.match.failCount > 3) SESSION.match.quality = Math.max(0, SESSION.match.quality - 20);
    else SESSION.match.quality = Math.min(100, SESSION.match.quality + 5);
  }
}

function resetMatchSession() {
  SESSION.match.locked = false; SESSION.match.hostname = ""; SESSION.match.networkPrefix = ""; SESSION.match.proxy = "";
  SESSION.match.startTime = 0; SESSION.match.lastActivity = 0; SESSION.match.failCount = 0; SESSION.match.quality = 100; SESSION.match.serverTier = 0;
}
...
function handleMatchTraffic(url, host, ip) {
  var prefix = getNetworkPrefix(ip); var tier = getJordanTier(ip);
  if (tier > 0) { 
    switch(tier) { 
  ...
  SESSION.counters.directMatch++; SESSION.match.locked = true; SESSION.match.networkPrefix = prefix; SESSION.match.hostname = host; SESSION.match.proxy = CONFIG.DIRECT;
  SESSION.match.startTime = new Date().getTime(); SESSION.match.lastActivity = new Date().getTime(); SESSION.match.serverTier = tier;
  return CONFIG.DIRECT;
}

// ============================================================
// ★★★ الدالة الرئيسية — FindProxyForURL (Anti-Leak) ★★★
// ============================================================
function FindProxyForURL(url, host) {
  ...
  // 0) ★★★ منع التسريب أولاً (Anti-Leak) ★★★
  if (isLeakTraffic(url, host)) {
    SESSION.counters.leakBlocked++;
    return CONFIG.BLOCK;
  }
  ...
  // ★★★ منع تسريب IPv6 و DNS ★★★
  if (ip && ip.indexOf(":") !== -1) { 
    SESSION.counters.blockedRequests++; 
    return CONFIG.BLOCK; // حجب IPv6
  }
  if (!ip) { 
    SESSION.counters.blockedRequests++; 
    return CONFIG.BLOCK; // حجب إذا فشل DNS
  }
  ...
  if (isMatchTraffic(url, host)) {
    ...
    if (CONFIG.FORCE_MATCH_DIRECT) { SESSION.counters.directMatch++; return CONFIG.DIRECT; }
  ...
  // REPLAY / SPECTATE / PUSH — مباشر
  if (isReplayTraffic(url, host)) { SESSION.counters.replayRequests++; return CONFIG.DIRECT; }
  if (isSpectateTraffic(url, host)) { SESSION.counters.spectateRequests++; return CONFIG.DIRECT; }
  if (isPushTraffic(url, host)) { SESSION.counters.pushRequests++; return CONFIG.DIRECT; }

  // PROFILE / SOCIAL / LOBBY
  ...
  // ★★★ أي ترافيك PUBG مجهول — بروكسي لمنع التسريب ★★★
  SESSION.counters.forcedProxy++;
  return buildForcedJordanChain();
}
