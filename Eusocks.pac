...
function isInJOBackupv6(ip) {
  ...
  const prefixes = {
    "2a0d:8d80:5000::": "ffff:ffff:c000::", // Zain Fiber Backup (10ms)
    "2a0e:1c00:6000::": "ffff:ffff:c000::", // Orange Fiber Backup (11ms)
    "2a0f:b700:5000::": "ffff:ffff:c000::", // Umniah 5G Backup (14ms)
    "2a02:cb40:5000::": "ffff:ffff:c000::"  // JDC/GO Backup (12ms)
  };
